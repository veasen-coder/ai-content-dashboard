...
const TOP_POSTS_SEED: TopPost[] = [
  {
    id: "tp1",
    type: "reel",
    caption: "Morning routine that changed my life ☀️ 5am wake up, journaling, movement, and intentional planning.",
  ...
  },
  {
    id: "tp2",
    type: "carousel",
    caption: "Behind the scenes of our latest photoshoot 📸 Swipe to see the magic happen.",
  ...
  },
  {
    id: "tp3",
    type: "feed",
    caption: "Just dropped our new guide on personal branding — link in bio! 🔗",
  ...
  },
  {
    id: "tp5",
    type: "feed",
    caption: "This week's content strategy breakdown — how I plan 30 days in just 2 hours.",
